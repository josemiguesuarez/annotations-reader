...
/**
 * Panel donde se muestra la informaci�n de los libros alquilados.
 */
...
public class PanelLibroAlquilado extends JPanel implements ActionListener
{
    ...
    /**
     * Etiqueta donde aparece el t�tulo.
     */
    ...
    /**
     * Bot�n para devolver una copia del libro.
     */
    ...
    /**
     * Constructor por defecto de la aplicaci�n.
     * @param elLibro que se le va mostrar la informaci�n.
     * @param nPrincipal La interfaz principal de la aplicaci�n.
     */
