...
public class PanelAccionAgregarLibro extends javax.swing.JPanel implements java.awt.event.ActionListener {
    ...
    public PanelAccionAgregarLibro(code.biblioteca.interfaz.InterfazBiblioteca nPrincipal) {
        ...
        botonAgregarCopia.addActionListener(code.biblioteca.interfaz.PanelAccionAgregarLibro.this);
        botonAgregarCopia.setActionCommand(code.biblioteca.interfaz.PanelAccionAgregarLibro.AGREGAR_COPIA);
    ...
    private void armarPanelContenedor() {
        ...
        botonAgregarLibroNuevo.addActionListener(code.biblioteca.interfaz.PanelAccionAgregarLibro.this);
        botonAgregarLibroNuevo.setActionCommand(code.biblioteca.interfaz.PanelAccionAgregarLibro.AGREGAR_LIBRO);
        ...
        botonCancelar.addActionListener(code.biblioteca.interfaz.PanelAccionAgregarLibro.this);
        botonCancelar.setActionCommand(code.biblioteca.interfaz.PanelAccionAgregarLibro.CANCELAR);
        panelContenedor.add(botonCancelar, gridBagConstraints15);
    }

    public void actionPerformed(java.awt.event.ActionEvent e) {
        if (e.getActionCommand().equals(code.biblioteca.interfaz.PanelAccionAgregarLibro.AGREGAR_COPIA)) {
            if (textoReferencia.getText().equals(""))
                ...
                } catch (code.biblioteca.mundo.excepciones.LibroInexistenteException e1) {
        ...
        if (e.getActionCommand().equals(code.biblioteca.interfaz.PanelAccionAgregarLibro.AGREGAR_LIBRO))
            accionBotonInsertarNuevoLibro();
        
        if (e.getActionCommand().equals(code.biblioteca.interfaz.PanelAccionAgregarLibro.CANCELAR)) {
            panelContenedor.setVisible(false);
    ...
    private void accionBotonInsertarNuevoLibro() {
        if (textoTitulo.getText().equals("")) {
            javax.swing.JOptionPane.showMessageDialog(principal, "Ingrese el t�tulo", "Error", javax.swing.JOptionPane.ERROR_MESSAGE);
            return ;
        } 
