...
/**
 * Panel de control de la aplicaci�n donde se pueden hacer las acciones que tienen que ver con los usuarios.
 */
...
public class PanelAcciones extends JPanel implements ActionListener, MouseListener
{
    ...
    /**
     * Bot�n para la acci�n de autenticaci�n.
     */
    ...
    public PanelAcciones( InterfazBiblioteca nPrincipal )
    {
        ...
        // Cuadro de texto de la contrase�a.
    ...
    /**
     * M�todo que se ejecuta cuando se hace alguna acci�n sobre los listener del panel.
    ...
    /**
     * Se ejecuta cuando se mantiene presionado el bot�n del mouse.
     * @param e Objeto donde va encapsulado los datos del evento.
     */
    ...
    /**
     * Se ejecuta cuando se suelta el bot�n del mouse.
     * @param e Objeto donde va encapsulado los datos del evento.
     */
    ...
    /**
     * Se ejecuta cuando se mueve el mouse sale del elemento que se est� escuchando.
     * @param e Objeto donde va encapsulado los datos del evento.
     */
